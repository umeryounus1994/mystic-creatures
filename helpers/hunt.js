...
module.exports.getAllTreasureHunt = async function (data) {
    const promiseArr = [];
    var result = [];
            ...
            promiseArr.push(
                new Promise(async (resolvve, rejectt) => {
                    ...
                    var el = {
                        ...
                        mythica: element?.treasure_hunt_id.mythica,
                        mythica_ar_model: element?.treasure_hunt_id.mythica_ar_model,
                        status: element.status,
